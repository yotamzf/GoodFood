...
class Validator {
    ...
    // Validates that the recipe title is not empty
    fun validateRecipeTitle(title: String): Boolean {
        return title.isNotEmpty()
    }

    // Validates that the recipe content is not empty
    fun validateRecipeContent(content: String): Boolean {
